...
public class TContainedMessageTest {
    ...
    public void setUp() {
        ...
        fields.add(new TField<>(null, 1, false, "field_bool", TPrimitive.BOOL.provider(), null));
        fields.add(new TField<>(null, 2, false, "field_8", TPrimitive.BYTE.provider(), null));
        fields.add(new TField<>(null, 65000, false, "field_16", TPrimitive.I16.provider(), null));
        fields.add(new TField<>(null, 4, false, "field_32", TPrimitive.I32.provider(), null));
        fields.add(new TField<>(null, 5, false, "field_64", TPrimitive.I64.provider(), null));
        fields.add(new TField<>(null, 6, false, "field_dbl", TPrimitive.DOUBLE.provider(), null));
        fields.add(new TField<>(null, 9998, false, "field_str", TPrimitive.STRING.provider(), null));
        fields.add(new TField<>(null, 9999, false, "field_bin", TPrimitive.BINARY.provider(), null));
        fields.add(new TField<>(null, 32000, false, "field_a", mRegistry.getProvider("TypeA", "test"), null));
