...
public class RequiredFields
    ...
    public enum _Field implements net.morimekta.providence.descriptor.PField {
        ...
        ENUM_VALUE(9, net.morimekta.providence.descriptor.PRequirement.REQUIRED, "enumValue", net.morimekta.test.providence.core.Value.provider(), null),
        COMPACT_VALUE(10, net.morimekta.providence.descriptor.PRequirement.REQUIRED, "compactValue", net.morimekta.test.providence.core.CompactFields.provider(), null),
        ;
