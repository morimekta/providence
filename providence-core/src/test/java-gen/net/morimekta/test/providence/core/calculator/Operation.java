                        ...
                        if (type == 15) {
                            ...
                            if (t_3 == 12) {
                                ...
                                for (int i_4 = 0; i_4 < len_2; ++i_4) {
                                    net.morimekta.test.providence.core.calculator.Operand key_5 = net.morimekta.providence.serializer.binary.BinaryFormatUtils.readMessage(reader, net.morimekta.test.providence.core.calculator.Operand.kDescriptor, strict);
                                    b_1.add(key_5);
                                }
                                mOperands = b_1.build();
                            } else {
