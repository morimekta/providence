...
public class Operand
    ...
    private final transient net.morimekta.test.providence.core.calculator.Operation mOperation;
    private final transient Double mNumber;
    private final transient net.morimekta.test.providence.core.number.Imaginary mImaginary;
     ...
     */
    @javax.annotation.Nonnull
    public java.util.Optional<net.morimekta.test.providence.core.number.Imaginary> optionalImaginary() {
