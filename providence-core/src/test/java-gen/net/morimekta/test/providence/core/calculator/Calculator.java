...
public class Calculator {
    ...
    protected static class _calculate_request
         ...
         */
        @javax.annotation.Nonnull
        public java.util.Optional<net.morimekta.test.providence.core.calculator.Operation> optionalOp() {
            ...
            public void readBinary(net.morimekta.util.io.BigEndianBinaryReader reader, boolean strict) throws java.io.IOException {
                ...
                while (type != 0) {
                    ...
                    switch (field) {
                        case 1: {
                            if (type == 12) {
                                mOp = net.morimekta.providence.serializer.binary.BinaryFormatUtils.readMessage(reader, net.morimekta.test.providence.core.calculator.Operation.kDescriptor, strict);
                                optionals.set(0);
                            } else {
    ...
    protected static class _calculate_response
         ...
         */
        @javax.annotation.Nonnull
        public java.util.Optional<net.morimekta.test.providence.core.calculator.Operand> optionalSuccess() {
         ...
         */
        @javax.annotation.Nonnull
        public java.util.Optional<net.morimekta.test.providence.core.calculator.CalculateException> optionalCe() {
            ...
            public void readBinary(net.morimekta.util.io.BigEndianBinaryReader reader, boolean strict) throws java.io.IOException {
                ...
                while (type != 0) {
                    ...
                    switch (field) {
                        case 0: {
                            if (type == 12) {
                                mSuccess = net.morimekta.providence.serializer.binary.BinaryFormatUtils.readMessage(reader, net.morimekta.test.providence.core.calculator.Operand.kDescriptor, strict);
                                tUnionField = _Field.SUCCESS;
                            } else {
                        ...
                        case 1: {
                            if (type == 12) {
                                mCe = net.morimekta.providence.serializer.binary.BinaryFormatUtils.readMessage(reader, net.morimekta.test.providence.core.calculator.CalculateException.kDescriptor, strict);
                                tUnionField = _Field.CE;
                            } else {
