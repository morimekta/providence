...
public class UnionFields
     ...
     * @return The created union.
     */
    public static UnionFields withEnumValue(net.morimekta.test.providence.core.no_rw_binary.Value value) {
     ...
     * @return The created union.
     */
    public static UnionFields withCompactValue(net.morimekta.test.providence.core.no_rw_binary.CompactFields value) {
    ...
    public enum _Field implements net.morimekta.providence.descriptor.PField {
        ...
        ENUM_VALUE(9, net.morimekta.providence.descriptor.PRequirement.OPTIONAL, "enumValue", net.morimekta.test.providence.core.no_rw_binary.Value.provider(), null),
