...
public class ThriftProgramParserTest {
    ...
    public void testParse_calculator_strict() throws IOException, ParseException {
        ...
        ProgramType calculator = parser.parse(getClass().getResourceAsStream("/parser/calculator/calculator_strict.thrift"),
                                              "calculator.thrift");
    ...
    public void testAutoId() throws IOException, ParseException {
        ThriftProgramParser parser = new ThriftProgramParser();
        ProgramType autoid = parser.parse(getClass().getResourceAsStream("/parser/tests/autoid.thrift"),
                                          "autoid.thrift");
    ...
    public void testAutoValue() throws IOException, ParseException {
        ThriftProgramParser parser = new ThriftProgramParser();
        ProgramType autoid = parser.parse(getClass().getResourceAsStream("/parser/tests/autovalue.thrift"),
                                          "autovalue.thrift");
    ...
    public void testParseExceptions() {
        ...
        assertBadStrictThrfit("Parse error on line 14, pos 7: Missing enum value in strict declaration\n" +
                              "    ADD,\n" +
                              "-------^",
                              "/parser/calculator/calculator.thrift");
    }
    ...
    private void assertBadStrictThrfit(String message, String resource) {
        try {
            ThriftProgramParser parser = new ThriftProgramParser(true, true);
            parser.parse(getClass().getResourceAsStream(resource), new File(resource).getName());
            fail("No exception on bad thrift: " + resource);
