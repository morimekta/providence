...
public class RequiredFields implements org.apache.thrift.TBase<RequiredFields, RequiredFields._Fields>, java.io.Serializable, Cloneable, Comparable<RequiredFields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RequiredFields");
  ...
  static {
    schemes.put(StandardScheme.class, new RequiredFieldsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RequiredFieldsTupleSchemeFactory());
  }
  ...
  private ByteBuffer binaryValue; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.BOOLEAN_VALUE, new org.apache.thrift.meta_data.FieldMetaData("booleanValue", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.BYTE_VALUE, new org.apache.thrift.meta_data.FieldMetaData("byteValue", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BYTE)));
    tmpMap.put(_Fields.SHORT_VALUE, new org.apache.thrift.meta_data.FieldMetaData("shortValue", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I16)));
    tmpMap.put(_Fields.INTEGER_VALUE, new org.apache.thrift.meta_data.FieldMetaData("integerValue", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.LONG_VALUE, new org.apache.thrift.meta_data.FieldMetaData("longValue", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.DOUBLE_VALUE, new org.apache.thrift.meta_data.FieldMetaData("doubleValue", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    tmpMap.put(_Fields.STRING_VALUE, new org.apache.thrift.meta_data.FieldMetaData("stringValue", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.BINARY_VALUE, new org.apache.thrift.meta_data.FieldMetaData("binaryValue", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , true)));
    tmpMap.put(_Fields.ENUM_VALUE, new org.apache.thrift.meta_data.FieldMetaData("enumValue", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, Value.class)));
    tmpMap.put(_Fields.COMPACT_VALUE, new org.apache.thrift.meta_data.FieldMetaData("compactValue", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, CompactFields.class)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RequiredFields.class, metaDataMap);
  }
   ...
   */
  public RequiredFields(RequiredFields other) {
  ...
  public RequiredFields deepCopy() {
  ...
  public RequiredFields setBooleanValue(boolean booleanValue) {
    this.booleanValue = booleanValue;
    setBooleanValueIsSet(true);
    return this;
  }
  ...
  public RequiredFields setByteValue(byte byteValue) {
    this.byteValue = byteValue;
    setByteValueIsSet(true);
    return this;
  }
  ...
  public RequiredFields setShortValue(short shortValue) {
    this.shortValue = shortValue;
    setShortValueIsSet(true);
    return this;
  }
  ...
  public RequiredFields setIntegerValue(int integerValue) {
    this.integerValue = integerValue;
    setIntegerValueIsSet(true);
    return this;
  }
  ...
  public void unsetIntegerValue() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __INTEGERVALUE_ISSET_ID);
  }

  /** Returns true if field integerValue is set (has been assigned a value) and false otherwise */
  public boolean isSetIntegerValue() {
    return EncodingUtils.testBit(__isset_bitfield, __INTEGERVALUE_ISSET_ID);
  }

  public void setIntegerValueIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __INTEGERVALUE_ISSET_ID, value);
  }
  ...
  public RequiredFields setLongValue(long longValue) {
    this.longValue = longValue;
    setLongValueIsSet(true);
    return this;
  }
  ...
  public RequiredFields setDoubleValue(double doubleValue) {
    this.doubleValue = doubleValue;
    setDoubleValueIsSet(true);
    return this;
  }
  ...
  public RequiredFields setStringValue(String stringValue) {
    this.stringValue = stringValue;
    return this;
  }
  ...
  public RequiredFields setBinaryValue(byte[] binaryValue) {
    this.binaryValue = binaryValue == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(binaryValue, binaryValue.length));
    return this;
  }

  public RequiredFields setBinaryValue(ByteBuffer binaryValue) {
    this.binaryValue = org.apache.thrift.TBaseHelper.copyBinary(binaryValue);
    return this;
  }
   ...
   * @see Value
   */
  public RequiredFields setEnumValue(Value enumValue) {
    this.enumValue = enumValue;
    return this;
  }
  ...
  public RequiredFields setCompactValue(CompactFields compactValue) {
    this.compactValue = compactValue;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RequiredFields)
      return this.equals((RequiredFields)that);
    return false;
  }

  public boolean equals(RequiredFields that) {
    if (that == null)
      return false;
  ...
  public int hashCode() {
    ...
    boolean present_byteValue = true;
    list.add(present_byteValue);
    if (present_byteValue)
      list.add(byteValue);

    boolean present_shortValue = true;
    list.add(present_shortValue);
    if (present_shortValue)
      list.add(shortValue);

    boolean present_integerValue = true;
    list.add(present_integerValue);
    if (present_integerValue)
    ...
    boolean present_enumValue = true && (isSetEnumValue());
    list.add(present_enumValue);
    if (present_enumValue)
      list.add(enumValue.getValue());

    boolean present_compactValue = true && (isSetCompactValue());
    list.add(present_compactValue);
    if (present_compactValue)
      list.add(compactValue);
  ...
  public int compareTo(RequiredFields other) {
    ...
    lastComparison = Boolean.valueOf(isSetIntegerValue()).compareTo(other.isSetIntegerValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetEnumValue()).compareTo(other.isSetEnumValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnumValue()) {
    ...
    lastComparison = Boolean.valueOf(isSetCompactValue()).compareTo(other.isSetCompactValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RequiredFields(");
    boolean first = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'booleanValue' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'byteValue' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'shortValue' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'integerValue' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'longValue' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'doubleValue' because it's a primitive and you chose the non-beans generator.
    if (stringValue == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'stringValue' was not present! Struct: " + toString());
    }
    if (binaryValue == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'binaryValue' was not present! Struct: " + toString());
    }
    if (enumValue == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'enumValue' was not present! Struct: " + toString());
    }
    if (compactValue == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'compactValue' was not present! Struct: " + toString());
    }
  ...
  private static class RequiredFieldsStandardSchemeFactory implements SchemeFactory {
    public RequiredFieldsStandardScheme getScheme() {
      return new RequiredFieldsStandardScheme();
    }
  }

  private static class RequiredFieldsStandardScheme extends StandardScheme<RequiredFields> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RequiredFields struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetBooleanValue()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'booleanValue' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetByteValue()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'byteValue' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetShortValue()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'shortValue' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetIntegerValue()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'integerValue' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetLongValue()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'longValue' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetDoubleValue()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'doubleValue' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(org.apache.thrift.protocol.TProtocol oprot, RequiredFields struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RequiredFieldsTupleSchemeFactory implements SchemeFactory {
    public RequiredFieldsTupleScheme getScheme() {
      return new RequiredFieldsTupleScheme();
    }
  }

  private static class RequiredFieldsTupleScheme extends TupleScheme<RequiredFields> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RequiredFields struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RequiredFields struct) throws org.apache.thrift.TException {
