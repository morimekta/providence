...
public class OptionalFields implements org.apache.thrift.TBase<OptionalFields, OptionalFields._Fields>, java.io.Serializable, Cloneable, Comparable<OptionalFields> {
  ...
  static {
    schemes.put(StandardScheme.class, new OptionalFieldsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OptionalFieldsTupleSchemeFactory());
  }
  ...
  public OptionalFields setStringValue(String stringValue) {
  ...
  public OptionalFields setBinaryValue(ByteBuffer binaryValue) {
  ...
  public int hashCode() {
    ...
    boolean present_booleanValue = true && (isSetBooleanValue());
    ...
    boolean present_shortValue = true && (isSetShortValue());
    list.add(present_shortValue);
    if (present_shortValue)
      list.add(shortValue);

    boolean present_integerValue = true && (isSetIntegerValue());
  ...
  private static class OptionalFieldsStandardSchemeFactory implements SchemeFactory {
    public OptionalFieldsStandardScheme getScheme() {
      return new OptionalFieldsStandardScheme();
    }
  }

  private static class OptionalFieldsStandardScheme extends StandardScheme<OptionalFields> {
  ...
  private static class OptionalFieldsTupleSchemeFactory implements SchemeFactory {
    public OptionalFieldsTupleScheme getScheme() {
      return new OptionalFieldsTupleScheme();
    }
  }

  private static class OptionalFieldsTupleScheme extends TupleScheme<OptionalFields> {
