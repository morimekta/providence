...
public class BaseTestService {
  ...
  public interface AsyncIface {
    ...
    public void inBaseService(org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    {
      send_inBaseService();
      return recv_inBaseService();
    }

    public void send_inBaseService() throws org.apache.thrift.TException
    {
      inBaseService_args args = new inBaseService_args();
      sendBase("inBaseService", args);
    }

    public int recv_inBaseService() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class inBaseService_call extends org.apache.thrift.async.TAsyncMethodCall {
      public inBaseService_call(org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public int getResult() throws org.apache.thrift.TException {
        ...
        return (new Client(prot)).recv_inBaseService();
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class inBaseService<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, inBaseService_args, Integer> {
      public inBaseService() {
        super("inBaseService");
      }
      ...
      public void start(I iface, inBaseService_args args, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws TException {
  ...
  public static class inBaseService_args implements org.apache.thrift.TBase<inBaseService_args, inBaseService_args._Fields>, java.io.Serializable, Cloneable, Comparable<inBaseService_args>   {
    ...
    static {
      schemes.put(StandardScheme.class, new inBaseService_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new inBaseService_argsTupleSchemeFactory());
    }
...
;
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("inBaseService_args(");
      boolean first = true;
    ...
    private static class inBaseService_argsStandardSchemeFactory implements SchemeFactory {
      public inBaseService_argsStandardScheme getScheme() {
        return new inBaseService_argsStandardScheme();
      }
    }

    private static class inBaseService_argsStandardScheme extends StandardScheme<inBaseService_args> {
    ...
    private static class inBaseService_argsTupleSchemeFactory implements SchemeFactory {
      public inBaseService_argsTupleScheme getScheme() {
        return new inBaseService_argsTupleScheme();
      }
    }

    private static class inBaseService_argsTupleScheme extends TupleScheme<inBaseService_args> {
  ...
  public static class inBaseService_result implements org.apache.thrift.TBase<inBaseService_result, inBaseService_result._Fields>, java.io.Serializable, Cloneable, Comparable<inBaseService_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new inBaseService_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new inBaseService_resultTupleSchemeFactory());
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("inBaseService_result(");
      boolean first = true;
    ...
    private static class inBaseService_resultStandardSchemeFactory implements SchemeFactory {
      public inBaseService_resultStandardScheme getScheme() {
        return new inBaseService_resultStandardScheme();
      }
    }

    private static class inBaseService_resultStandardScheme extends StandardScheme<inBaseService_result> {
    ...
    private static class inBaseService_resultTupleSchemeFactory implements SchemeFactory {
      public inBaseService_resultTupleScheme getScheme() {
        return new inBaseService_resultTupleScheme();
      }
    }

    private static class inBaseService_resultTupleScheme extends TupleScheme<inBaseService_result> {
