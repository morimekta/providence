    ...
    public void testHelp() {
        ...
        assertThat(console.output(),
                   is(equalToLines("Providence generator - " + version + "\n" +
                                   ...
                                   " --allow-language-reserved-names : Allow language-reserved words in type names (default: true)\n" +
                                   " --no-language-reserved-names  : Do not allow language-reserved words in type names\n" +
