...
public class TPrimitiveTest {
    ...
    public void testGetTypeGroup() {
        assertEquals(TType.BOOL, TPrimitive.BOOL.getType());
        assertEquals(TType.BYTE, TPrimitive.BYTE.getType());
        assertEquals(TType.I16, TPrimitive.I16.getType());
        assertEquals(TType.I32, TPrimitive.I32.getType());
        assertEquals(TType.I64, TPrimitive.I64.getType());
        assertEquals(TType.DOUBLE, TPrimitive.DOUBLE.getType());
        assertEquals(TType.STRING, TPrimitive.STRING.getType());
        assertEquals(TType.BINARY, TPrimitive.BINARY.getType());
    }
