...
public class TServiceMethod<R,
    ...
    public boolean equals(Object o) {
        ...
        return mOneway == other.mOneway &&
               ...
               equalsQualifiedName(getReturnType(), other.getReturnType()) &&
               equalsQualifiedName(getParamsDescriptor(), other.getParamsDescriptor()) &&
               equalsQualifiedName(getExceptionDescriptor(), other.getExceptionDescriptor());
    }
