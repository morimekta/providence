 ...
 */
public class TBinary implements Comparable<TBinary> {
    private final byte[] bytes;

    public TBinary(byte[] bytes) {
        this.bytes = bytes;
    }
     ...
     */
    public static TBinary wrap(byte[] bytes) {
        return new TBinary(bytes);
    }
     ...
     * @return The wrapped byte sequence.
     */
    public static TBinary copy(byte[] bytes) {
     ...
     * @return The wrapped byte sequence.
     */
    public static TBinary copy(byte[] bytes, int off, int len) {
     ...
     */
    public static TBinary fromBase64(String base64) {
        byte[] arr = TBase64Utils.decode(base64);
        return new TBinary(arr);
    }
     ...
     */
    public static TBinary fromHexString(String hex) {
     ...
     */
    public static TBinary read(InputStream in, int len) throws IOException {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TBinary)) return false;
        TBinary other = (TBinary) o;
    ...
    @Override
    public int compareTo(TBinary other) {
