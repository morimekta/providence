...
public class PSerializerTest {
     ...
     * @throws PSerializeException
     */
    public void testOutput(PSerializer serializer, String resource, boolean binary) throws IOException, PSerializeException {
        Binary expected;
        ...
        if (binary) {
            ...
            assertEquals(new String(expected.get()),
    ...
    public void testPrettyJson() throws PSerializeException, IOException {
        PSerializer serializer = new PJsonSerializer(true, PJsonSerializer.IdType.NAME, PJsonSerializer.IdType.NAME, true);
        testSerializer(serializer);
