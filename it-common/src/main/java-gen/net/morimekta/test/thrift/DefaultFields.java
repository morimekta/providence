...
public class DefaultFields implements org.apache.thrift.TBase<DefaultFields, DefaultFields._Fields>, java.io.Serializable, Cloneable, Comparable<DefaultFields> {
  ...
  static {
    schemes.put(StandardScheme.class, new DefaultFieldsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DefaultFieldsTupleSchemeFactory());
  }
  ...
  public DefaultFields setStringValue(String stringValue) {
    this.stringValue = stringValue;
    return this;
  }
  ...
  public DefaultFields setBinaryValue(ByteBuffer binaryValue) {
    this.binaryValue = org.apache.thrift.TBaseHelper.copyBinary(binaryValue);
    return this;
  }
  ...
  private static class DefaultFieldsStandardSchemeFactory implements SchemeFactory {
    public DefaultFieldsStandardScheme getScheme() {
      return new DefaultFieldsStandardScheme();
    }
  }

  private static class DefaultFieldsStandardScheme extends StandardScheme<DefaultFields> {
  ...
  private static class DefaultFieldsTupleSchemeFactory implements SchemeFactory {
    public DefaultFieldsTupleScheme getScheme() {
      return new DefaultFieldsTupleScheme();
    }
  }

  private static class DefaultFieldsTupleScheme extends TupleScheme<DefaultFields> {
