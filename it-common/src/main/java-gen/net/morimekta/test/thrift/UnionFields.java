...
public class UnionFields extends org.apache.thrift.TUnion<UnionFields, UnionFields._Fields> {
  ...
  public UnionFields(_Fields setField, Object value) {
  ...
  public static UnionFields stringValue(String value) {
    UnionFields x = new UnionFields();
    x.setStringValue(value);
    return x;
  }

  public static UnionFields binaryValue(ByteBuffer value) {
    UnionFields x = new UnionFields();
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case ENUM_VALUE:
        ...
        throw new ClassCastException("Was expecting value of type Value for field 'enumValue', but got " + value.getClass().getSimpleName());
      case COMPACT_VALUE:
        if (value instanceof CompactFields) {
          break;
        }
        throw new ClassCastException("Was expecting value of type CompactFields for field 'compactValue', but got " + value.getClass().getSimpleName());
      default:
  ...
  public Value getEnumValue() {
    if (getSetField() == _Fields.ENUM_VALUE) {
      ...
      throw new RuntimeException("Cannot get field 'enumValue' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public CompactFields getCompactValue() {
    if (getSetField() == _Fields.COMPACT_VALUE) {
      ...
      throw new RuntimeException("Cannot get field 'compactValue' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
