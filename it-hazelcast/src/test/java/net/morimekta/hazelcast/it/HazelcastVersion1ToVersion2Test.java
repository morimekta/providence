...
/**
 * In version 1 to version 2 we have changed from the structure to add one field for the PortableFields
 * as seen below, and PortableListFields that you can see at {@link net.morimekta.test.hazelcast.v1.PortableListFields}
 * and {@link net.morimekta.test.hazelcast.v2.PortableListFields}
...
public class HazelcastVersion1ToVersion2Test extends GenericMethods {
    ...
    public void testUpgradeIntegrityAll() throws InterruptedException {
        ...
        assertMapUpgradeIntegrity(instance1, instance2,
                                  net.morimekta.test.hazelcast.v1.PortableFields.kDescriptor,
    ...
    public void testUpgradeIntegrityAll_list() throws InterruptedException {
        generator.getBaseContext().setDefaultFillRate(1.0);
        assertMapUpgradeIntegrity(instance1, instance2,
                                  net.morimekta.test.hazelcast.v1.PortableListFields.kDescriptor,
    ...
    public void testUpgradeIntegrityAll_set() throws InterruptedException {
        generator.getBaseContext().setDefaultFillRate(1.0);
        assertMapUpgradeIntegrity(instance1, instance2,
                                  net.morimekta.test.hazelcast.v1.PortableSetFields.kDescriptor,
    ...
    public void testUpgradeIntegrityAll_map() throws InterruptedException {
        generator.getBaseContext().setDefaultFillRate(1.0);
        assertMapUpgradeIntegrity(instance1, instance2,
                                  net.morimekta.test.hazelcast.v1.PortableMapFields.kDescriptor,
    ...
    public void testUpgradeIntegrityAll_maplist() throws InterruptedException {
        generator.getBaseContext().setDefaultFillRate(1.0);
        assertMapUpgradeIntegrity(instance1, instance2,
                                  net.morimekta.test.hazelcast.v1.PortableMapListFields.kDescriptor,
    ...
    public void testUpgradeIntegrityAll_mapset() throws InterruptedException {
        generator.getBaseContext().setDefaultFillRate(1.0);
        assertMapUpgradeIntegrity(instance1, instance2,
                                  net.morimekta.test.hazelcast.v1.PortableMapSetFields.kDescriptor,
    ...
    public void testV2WithV1Config() throws InterruptedException {
        try {
            ...
            IMap<String, net.morimekta.test.hazelcast.v2.PortableFields._Builder> writeMap = instance1.getMap(mapName);
            ...
            assertThat(e.getCause().getMessage(), is("Invalid field name: 'notPortableValue' for ClassDefinition {id: 2, version: 1}"));
        }
    }
}
